...
for i in range(1,register_number+1):
    ...
    np.savetxt( directory + "acuity_right.csv", right, delimiter=",")
    np.savetxt( directory + "acuity_left.csv", left, delimiter=",")
    np.savetxt( directory + "acuity_both.csv", both, delimiter=",")
